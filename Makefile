MODULE_NAME := mod_yscbsubs_expiredlist
MANIFEST := mod_yscbsubs_expiredlist.xml
UPDATE_XML := mod_yscbsubs_expiredlist.update.xml
INSTALL_DIR := installation

VERSION := $(shell awk -F'[<>]' '/<version>/{print $$3; exit}' mod_yscbsubs_expiredlist.xml)
