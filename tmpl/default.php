...
if ($planId === 0) {
    echo '<div class="alert alert-warning">' . htmlspecialchars(Text::_('MOD_YSCBSUBS_EXPIREDLIST_NO_PLAN'), ENT_QUOTES, 'UTF-8') . '</div>';
    return;
}

// Show message if no results
if (empty($list)) {
    echo '<div class="alert alert-info">' . htmlspecialchars(Text::_('MOD_YSCBSUBS_EXPIREDLIST_NO_RESULTS'), ENT_QUOTES, 'UTF-8') . '</div>';
    return;
}
